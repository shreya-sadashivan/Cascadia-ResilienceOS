...
import {
  require_react_dom
} from "./chunk-PW32YM6A.js";
import {
  require_jsx_runtime
} from "./chunk-NB2VUFJ5.js";
import {
  createSlot,
  createSlottable,
  useComposedRefs
} from "./chunk-NFQNIJLA.js";
import {
  require_react
...
var Arrow = React8.forwardRef(
  __name7(function Arrow2(props, forwardedRef) {
...
var Popper = __name9((props) => {
  const { __scopePopper, children } = props;
  const [anchor, setAnchor] = React10.useState(null);
  const [placementState, setPlacementState] = React10.useState(void 0);
...
var PopperAnchor = React10.forwardRef(
  __name9(function PopperAnchor2(props, forwardedRef) {
    const { __scopePopper, virtualRef, ...anchorProps } = props;
    const context = usePopperContext(ANCHOR_NAME, __scopePopper);
    const ref = React10.useRef(null);
    const onAnchorChange = context.onAnchorChange;
    const callbackRef = React10.useCallback(
      (node) => {
        ref.current = node;
        if (node) {
          onAnchorChange(node);
    ...
    return virtualRef ? null : (0, import_jsx_runtime5.jsx)(
      Primitive.div,
      {
...
var PopperContent = React10.forwardRef(
  __name9(function PopperContent2(props, forwardedRef) {
    const {
      __scopePopper,
      side = "bottom",
      sideOffset = 0,
    ...
    const { refs, floatingStyles, placement, isPositioned, middlewareData } = useFloating({
      ...
      whileElementsMounted: __name9((...args) => {
      ...
      middleware: [
        ...
        size3({
          ...detectOverflowOptions,
          apply: __name9(({ elements, rects, availableWidth, availableHeight }) => {
...
var PopperArrow = React10.forwardRef(
  __name9(function PopperArrow2(props, forwardedRef) {
...
__name9(isNotNull, "isNotNull");
var transformOrigin = __name9((options) => ({
...
__name9(getSideAndAlignFromPlacement, "getSideAndAlignFromPlacement");
var Root2 = Popper;
...
var Portal = React11.forwardRef(
  __name10(function Portal2(props, forwardedRef) {
    const { container: containerProp, ...portalProps } = props;
    const [mounted, setMounted] = React11.useState(false);
    useLayoutEffect2(() => setMounted(true), []);
    const container = containerProp || mounted && globalThis?.document?.body;
    return container ? ReactDOM3.createPortal((0, import_jsx_runtime6.jsx)(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
  }, "Portal")
);
...
__name11(useStateMachine, "useStateMachine");
var Presence = __name11((props) => {
...
function usePresence(present) {
  ...
  useLayoutEffect2(() => {
    if (node) {
      ...
      const handleAnimationEnd = __name11((event) => {
      ...
      const handleAnimationStart = __name11((event) => {
...
__name11(usePresence, "usePresence");
...
__name11(useStableComposedRefs, "useStableComposedRefs");
function getAnimationName(styles) {
  return styles?.animationName || "none";
}
__name11(getAnimationName, "getAnimationName");
...
__name11(getElementRef, "getElementRef");
...
__name12(useEffectEvent, "useEffectEvent");
...
__name13(useControllableState, "useControllableState");
...
__name13(useUncontrolledState, "useUncontrolledState");
function isFunction(value) {
  return typeof value === "function";
}
__name13(isFunction, "isFunction");
...
__name13(useControllableStateReducer, "useControllableStateReducer");
...
var VisuallyHidden = React15.forwardRef(
  __name14(function VisuallyHidden2(props, forwardedRef) {
...
var TooltipProvider = __name15((props) => {
  const {
    __scopeTooltip,
  ...
  const isOpenDelayedRef = React16.useRef(true);
  const isPointerInTransitRef = React16.useRef(false);
  const skipDelayTimerRef = React16.useRef(0);
  React16.useEffect(() => {
  ...
  return (0, import_jsx_runtime8.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React16.useCallback(() => {
        if (skipDelayDuration <= 0) return;
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, [skipDelayDuration]),
      onClose: React16.useCallback(() => {
        if (skipDelayDuration <= 0) return;
        window.clearTimeout(skipDelayTimerRef.current);
      ...
      onPointerInTransitChange: React16.useCallback((inTransit) => {
...
var Tooltip = __name15((props) => {
  ...
  const [contentIdState, setContentId] = React16.useState(void 0);
  const generatedContentId = useId();
  const openTimerRef = React16.useRef(0);
  const disableHoverableContent = disableHoverableContentProp ?? providerContext.disableHoverableContent;
  const delayDuration = delayDurationProp ?? providerContext.delayDuration;
  const wasOpenDelayedRef = React16.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: __name15((open2) => {
      if (open2) {
  ...
  const stateAttribute = React16.useMemo(() => {
  ...
  const handleDelayedOpen = React16.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
  ...
  return (0, import_jsx_runtime8.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime8.jsx)(
    TooltipContextProvider,
    {
      ...
      onTriggerEnter: React16.useCallback(() => {
...
var TooltipTrigger = React16.forwardRef(
  __name15(function TooltipTrigger2(props, forwardedRef) {
    ...
    const handlePointerUp = React16.useCallback(() => isPointerDownRef.current = false, []);
    React16.useEffect(() => {
...
var TooltipPortal = __name15((props) => {
...
var TooltipContent = React16.forwardRef(
  __name15(function TooltipContent2(props, forwardedRef) {
...
var TooltipContentHoverable = React16.forwardRef(__name15(function TooltipContentHoverable2(props, forwardedRef) {
  const context = useTooltipContext(CONTENT_NAME2, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME2, props.__scopeTooltip);
  const ref = React16.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React16.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React16.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React16.useCallback(
    (event, hoverTarget) => {
  ...
  React16.useEffect(() => {
    if (trigger && content) {
      const handleTriggerLeave = __name15((event) => handleCreateGraceArea(event, content), "handleTriggerLeave");
      const handleContentLeave = __name15((event) => handleCreateGraceArea(event, trigger), "handleContentLeave");
  ...
  React16.useEffect(() => {
    if (pointerGraceArea) {
      const handleTrackPointerGrace = __name15((event) => {
        const target = event.target;
...
var TooltipContentImpl = React16.forwardRef(
  // blank line to reduce diff noise
  __name15(function TooltipContentImpl2(props, forwardedRef) {
    const {
      __scopeTooltip,
      children,
    ...
    React16.useEffect(() => {
      if (context.trigger) {
        const handleScroll = __name15((event) => {
...
var TooltipArrow = React16.forwardRef(
  __name15(function TooltipArrow2(props, forwardedRef) {
...
__name15(getExitSideFromRect, "getExitSideFromRect");
...
__name15(getPaddedExitPoints, "getPaddedExitPoints");
...
__name15(getPointsFromRect, "getPointsFromRect");
...
__name15(isPointInPolygon, "isPointInPolygon");
...
__name15(getHullPresorted, "getHullPresorted");
